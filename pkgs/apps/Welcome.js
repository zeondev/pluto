export default {
  ...
  strings: {
    en_US: {
      ...
      welcome_page2_language_tr_TR: "Türkçe (Türkiye)",
    ...
    tr_TR: {
      welcome_window_title: "Hoşgeldiniz",
      welcome_page1_header: "Plüton'a Hoşgeldiniz",
      welcome_page1_body:
        "Merhaba! Plüton'a hoş geldiniz, web için yeni bir 'masaüstü ortamı'.\n\nKuruluma başlamak için Sonraki'ye basın.",
      welcome_page2_header: "Dilinizinizi Ayarlayın",
      welcome_page2_body: "Mevcut dil Türkçe (Türkiye).",
      welcome_page2_language_en_US: "İngilizce (ABD)",
      welcome_page2_language_en_GB: "İngilizce (İngiltere)",
      welcome_page2_language_de_DE: "Almanca (Almanya)",
      welcome_page2_language_es_ES: "İspanyolca (İspanya)",
      welcome_page2_language_pt_BR: "Portekizce (Brezilya)",
      welcome_page2_language_fil_PH: "Filipince (Filipinler)",
      welcome_page2_language_tr_TR: "Türkçe (Türkiye)",
      welcome_page3_header: "Kişiselleştirin",
      welcome_page3_body: "Favori temanızızı seçin.",
      welcome_page4_header: "Sisteminiz artık kuruldu!",
      welcome_page4_body:
        "Ayarlarınızı kaydedip uygulamadan çıkmak için Bitir düğmesine basın.",
    },
  },
